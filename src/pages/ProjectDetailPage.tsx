        ...
        <div className="container-max px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-start w-full">
            ...
            <div className="space-y-4">
              <div className="aspect-[16/9] sm:aspect-[4/3] rounded-xl sm:rounded-2xl overflow-hidden bg-gradient-to-br from-primary/10 to-primary/10">
                 <img
              ...
              {/* View All Images Button removed as requested */}
              
              {/* Thumbnail Images */}
              <div className="flex gap-2 sm:gap-3 overflow-x-auto pb-2 -mx-4 px-4 sm:m-0 sm:p-0">
                {project.images.map((img, index) => (
                  <button
                    key={index}
                    onClick={() => setSelectedImage(index)}
                    className={`flex-shrink-0 aspect-[4/3] w-20 sm:w-24 rounded-md sm:rounded-lg overflow-hidden border-2 transition-all ${
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                <div className="bg-gray-50 rounded-xl p-4">
                  <div className="text-lg sm:text-2xl font-bold text-primary mb-1">{project.area}</div>
                  <div className="text-xs sm:text-sm text-muted-foreground">Total Area</div>
                </div>
                <div className="bg-gray-50 rounded-xl p-4">
                  <div className="text-lg sm:text-2xl font-bold text-primary mb-1">{project.duration}</div>
                  <div className="text-xs sm:text-sm text-muted-foreground">Duration</div>
                </div>
                <div className="bg-gray-50 rounded-xl p-4">
                  <div className="text-lg sm:text-2xl font-bold text-primary mb-1">{project.teamSize}</div>
                  <div className="text-xs sm:text-sm text-muted-foreground">Team Size</div>
                </div>
                <div className="bg-gray-50 rounded-xl p-4">
                  <div className="text-lg sm:text-2xl font-bold text-primary mb-1">{project.client}</div>
          ...
          <div className="flex flex-wrap gap-2 mb-8">
            {[
              ...
              <button
                ...
                className={`px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-medium transition-all duration-300 ${
                  selectedTab === tab.id
          ...
          <div className="bg-white rounded-2xl p-4 sm:p-8 shadow-sm">
            {selectedTab === 'overview' && (
              <div className="space-y-6">
                <h3 className="text-xl sm:text-2xl font-bold text-foreground">Project Overview</h3>
